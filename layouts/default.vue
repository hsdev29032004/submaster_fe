<template>
    <div style="display: flex; flex-direction: column; min-height: 100vh;">
        <header class="shadow-sm dark:shadow-white/20 px-1">
            <div class="inner-header">
                <UContainer class="flex justify-between items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <USwitch v-model="isDark" class="ml-4" checked-icon="i-lucide-moon"
        ...
        <footer class="border-t border-[#ddd] dark:border-[#1f2937]">
            <UContainer class="flex justify-between">
                <p>@Submaster - Bilingual subtitles from any youtube video</p>
                <p>Version: 0.0.1</p>
            </UContainer>
        </footer>
    </div>
