<template>
        ...
        >
            <div class="text-center sm:w-[70%] lg:w-1/2">
                ...
                <p class="text-[11px] sm:text-[13px] lg:text-[15px] mt-2">
                    Instantly bilingual subtitles from any youtube video.
                    Improve your language skills while watching your favorite
                    videos.
                </p>
            </div>
    ...
    <section id="features" class="scroll-mt-[80px]">
        ...
        >
            <div class="text-center sm:w-[70%] lg:w-1/2">
                <h1
                    class="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#05df72]"
                >
                    Features
                </h1>
                <p class="text-[11px] sm:text-[13px] lg:text-[15px] mt-2">
                    Our designs are optimized to offer seamless interactions and
                    efficiency, while integrating advanced functionalities that
            ...
            >
                <div>
                    ...
                    <p class="text-[11px]">
                        Download the app and start translating subtitles in
                        seconds
                    </p>
                </div>
                <div class="ml-3">
                    <Button type="success">Download App</Button>
                </div>
            </div>
        </UContainer>
    </section>
    ...
    <section id="pricing" class="scroll-mt-[100px]">
        ...
        >
            <div class="text-center sm:w-[70%] lg:w-1/2">
                ...
                <p class="text-[11px] sm:text-[13px] lg:text-[15px] mt-2">
                    Flexible pricing for language learners — Access bilingual
                    subtitles with our free plan, and unlock advanced features
                    as you grow. No credit card needed to get started.
                </p>
            </div>
            <Price />
        </UContainer>
